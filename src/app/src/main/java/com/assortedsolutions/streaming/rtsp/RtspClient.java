...
import com.assortedsolutions.streaming.rtp.RtpSocket;
...
public class RtspClient
{
    ...
    public RtspClient()
    {
        ...
        new HandlerThread("com.assortedsolutions.streaming.RtspClient")
        {
            @Override
    ...
    private void abort()
    {
        ...
        {
            Log.e(TAG, "Send request to teardown threw", ignore);
        }
        ...
        {
            Log.e(TAG, "Socket close threw", ignore);
        }
    ...
    private String computeMd5Hash(String buffer)
    {
        ...
        {
            Log.e(TAG, "No such algorithm thrown", ignore);
        }
        catch (UnsupportedEncodingException e)
        {
            Log.e(TAG, "Unsupported encoding thrown", e);
