    ...
    static class Selector
    {
        ...
        public static Codecs findCodecsFormMimeType(String mimeType, boolean tryColorFormatSurface)
        {
            ...
            if (Build.VERSION.SDK_INT >= 18 && tryColorFormatSurface)
            {
                ...
                {
                    Log.e(TAG, "Getting hardware codecs threw", e);
                }
                ...
                {
                    Log.e(TAG, "Getting software codecs threw", e);
                }

                if (list.hardwareCodec != null)
                {
                    Log.v(TAG,"Chosen primary codec: " + list.hardwareCodec + " with color format: " + list.hardwareColorFormat);
                }
                else
                {
                ...
                {
                    Log.v(TAG,"Chosen secondary codec: " + list.softwareCodec + " with color format: " + list.softwareCodec);
                }
                else
                {
            ...
            if (list.softwareCodec != null)
            {
                Log.v(TAG,"Chosen secondary codec: " + list.softwareCodec + " with color format: " + list.softwareColorFormat);
            }
            else
            {
                Log.e(TAG,"No supported software codec found!");
