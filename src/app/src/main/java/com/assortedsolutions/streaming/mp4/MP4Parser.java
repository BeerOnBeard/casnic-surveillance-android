...
public class MP4Parser
{
    ...
    private MP4Parser(final String path) throws IOException, FileNotFoundException
    {
        ...
        {
            Log.e(TAG, "Parsing threw", e);
            throw new IOException("Parse error: malformed mp4 file", e);
        }
    }
    ...
    public void close()
    {
        ...
        {
            Log.e(TAG, "Closing file threw", e);
        }
    }
    ...
    public StsdBox getStsdBox() throws IOException
    {
        ...
        {
            throw new IOException("stsd box could not be found", e);
        }
    }
